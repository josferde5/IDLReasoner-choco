...
import idlanalyzer.analyzer.operations.oas.AnalysisOperation;
import idlanalyzer.analyzer.operations.oas.OASConsistent;
import idlanalyzer.analyzer.operations.oas.OASDeadParameter;
import idlanalyzer.analyzer.operations.oas.OASFalseOptional;
import idlanalyzer.analyzer.operations.oas.OASRandomRequest;
import idlanalyzer.analyzer.operations.oas.OASValidIDL;
import idlanalyzer.analyzer.operations.oas.OASValidRequest;
import idlanalyzer.analyzer.operations.oas.RequestGenerationOperation;
...
public class OASAnalyzer extends Analyzer {
	...
	/**
	 * This constructor passes the received parameters to
	 * {@link idlanalyzer.analyzer.Analyzer#Analyzer(String, String, String, String, boolean)}
	 ...
	 * 
	 * @see OASMapper
	 * @see idlanalyzer.configuration.IDLConfiguration
	 * 
	 * @throws IDLException IDL exception.
	 */
	public OASAnalyzer(String specificationType, String apiSpecification, String operationPath, String operationType,
