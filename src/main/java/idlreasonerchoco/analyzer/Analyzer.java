...
public class Analyzer {
	...
	public Analyzer(String specificationType, String idlPath, String apiSpecificationPath, String operationPath, String operationType) {
		...
		this.resolutor = createResolutor(configuration);
		this.mapper = createMapper(configuration, specificationType, idlPath, apiSpecificationPath, operationPath, operationType);
	}
