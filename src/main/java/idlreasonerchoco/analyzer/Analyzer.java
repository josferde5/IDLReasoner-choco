...
public abstract class Analyzer {
	 ...
	 * @see idlreasonerchoco.analyzer.operations.oas.OASConsistent
	 * @see idlreasonerchoco.analyzer.operations.oas.OASDeadParameter
	 * @see idlreasonerchoco.analyzer.operations.oas.OASFalseOptional
	 * @throws IDLException IDL exception.
	 */
